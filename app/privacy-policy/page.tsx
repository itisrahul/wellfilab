  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-14">
      ...
      <div className="article-body font-reading">
        <p>WellFiLab collects your email address when you subscribe to a paid plan. The WellFiLab Score never requires an email or account — your answers, score history, and any plan subscription status shown on your dashboard are stored only in your browser, on your device. If you sign in to view the member dashboard, we also store the basic account details (name, email) your sign-in provider gives us.</p>
