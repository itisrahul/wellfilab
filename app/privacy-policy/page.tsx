  ...
  return (
    <div className="max-w-2xl mx-auto px-4 py-14">
      ...
      <div className="article-body font-reading">
        ...
        <p>Payments are processed by Stripe. We do not store card details. See <a href="https://stripe.com/privacy" target="_blank" rel="noopener noreferrer" className="text-teal-600 underline">Stripe&apos;s Privacy Policy</a>.</p>
