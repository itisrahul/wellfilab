...
export const CALCULATORS: Calculator[] = [
  ...
  { slug:'loan',category:'finance',group:'Borrow Money',icon:'🏛️',popular:true,title:'Loan & EMI Calculator',short:'Loan / EMI',desc:'Calculate monthly payments, total interest and full amortization. Compare extra payment impact.',metaDesc:'Free loan EMI calculator with amortization and extra payment analysis.',tags:['emi','loan','interest'],tips:['Even one extra payment per year cuts your loan significantly.','A 0.5% lower rate on a large loan saves thousands.'],faq:[{q:'How is EMI calculated?',a:'EMI = P × r × (1+r)^n ÷ ((1+r)^n − 1)'}],wflTopics:[{title:'How to get the best loan interest rate',slug:'home-loan-guide-india'},{title:'Should you prepay your loan?',slug:'home-loan-guide-india'}],
    content:{
  ...
  { slug:'mortgage',category:'finance',group:'Borrow Money',icon:'🏠',title:'Mortgage Calculator',short:'Mortgage',desc:'Monthly mortgage payments and total interest. See impact of extra payments.',metaDesc:'Free mortgage calculator. Monthly payment and extra payment analysis.',tags:['mortgage','home loan'],tips:['A 20% down payment removes PMI costs.','Fixed rates are safer for long-term planning.'],faq:[{q:'Fixed or variable rate?',a:'Fixed is predictable and safe. Variable may start lower but can rise.'}],wflTopics:[{title:'First-time home buyer guide',slug:'home-loan-guide-india'}],
    content:{
  ...
  // FINANCE — Plan Ahead
  { slug:'retirement',category:'finance',group:'Plan Ahead',icon:'🌅',popular:true,title:'Retirement Calculator',short:'Retirement',desc:'Find corpus needed, monthly savings required and your FIRE number. Inflation-adjusted.',metaDesc:'Free retirement calculator. Corpus and monthly savings, inflation-adjusted.',tags:['retirement','pension'],tips:['4% rule: withdraw 4%/year — sustainable for 30+ years.','Starting at 25 vs 35 can halve the monthly savings needed.'],faq:[{q:'How much do I need to retire?',a:'25–30× your annual expenses at retirement.'}],wflTopics:[{title:'Retirement planning in your 30s',slug:'retirement-planning-india'},{title:'NPS vs PPF: which is better?',slug:'retirement-planning-india'}],recommendations:[{label:'Best retirement plans',url:'https://wellfilab.com/recommend/retirement',icon:'🌅'},{label:'Compare NPS and PPF',url:'https://wellfilab.com/recommend/nps-ppf',icon:'📋'}],
    content:{
