  ...
  return (
    <div>
      ...
      <input
        ...
        className="w-full h-1.5 rounded-full bg-gray-200 dark:bg-gray-700 accent-teal-600 cursor-pointer"
      />
    </div>
  );
}
...
export function LiveScoreDemo() {
  ...
  return (
    <div className="relative">
      <div className="absolute -inset-4 bg-gradient-to-br from-teal-500/10 to-amber-400/10 rounded-[2rem] blur-2xl pointer-events-none" />
      <div className="relative bg-white dark:bg-gray-900 rounded-3xl border border-gray-200 dark:border-gray-800 shadow-xl p-6 sm:p-7">
        <p className="text-[10px] font-bold uppercase tracking-widest text-gray-400 mb-5">Try it — this is really calculating</p>
        ...
        <div className="flex items-center gap-4 p-4 rounded-2xl bg-gray-50 dark:bg-gray-800/60">
        ...
        <p className="text-[10px] text-gray-400 mt-3">Using typical defaults for diet, weight & hydration — the full score uses your real numbers for everything.</p>

        <Link href="/score" className="mt-4 flex items-center justify-center gap-2 w-full px-5 py-3 rounded-xl bg-teal-600 hover:bg-teal-700 text-white font-bold text-sm transition-all">
