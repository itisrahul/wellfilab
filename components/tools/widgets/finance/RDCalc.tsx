    ...
    <Shell
      ...
      right={<>
        ...
        <Box icon="💡 RD vs SIP" color="orange"
          text="RDs offer guaranteed, fixed returns with zero market risk — ideal for short-term goals. A SIP in equity mutual funds has historically returned more over 5+ years, but with volatility RDs don't have."/>
